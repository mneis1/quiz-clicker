# Initial Setup
- **Prerequisite**: Install node.js (Use this link: https://nodejs.org/en/download/)
- Clone this repo to your local system
- cd into the project directory 
- run the command `npm install`. This will automatically download the necessary dependencies
- now run `npm run dev`
- open http://localhost:3000 in your browser
- if you see the text "Welcome to next.js!", your local was setup successfully!
- _Ill add instructions on how to setup the debugger at another time_
